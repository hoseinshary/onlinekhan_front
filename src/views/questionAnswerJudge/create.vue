<template>
  <section class="row gutter-sm">
    ...
    <div class="col-12">
      <base-btn-create :label="`ایجاد`" @click="questionAnswerJudgeStore.submitCreate()" />
    </div>
  </section>
</template>
...
export default class QuestionAnswerJudgeCreateVue extends Vue {
  $v: any;
  ...
  //#region ### hooks ###
  created() {
    this.questionAnswerJudgeStore.SET_CREATE_VUE(this);
  }
  //#endregion
}
</script>
