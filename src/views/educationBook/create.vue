<template>
  <base-modal-create
    ...
    :show="educationBookStore.openModal.create"
    size="lg"
    @confirm="educationBookStore.submitCreate"
    @reset="educationBookStore.resetCreate"
    @open="open"
    @close="educationBookStore.OPEN_MODAL_CREATE(false)"
  >
...
export default class EducationBookCreateVue extends Vue {
  $v: any;
  ...
  //#region ### hooks ###
  created() {
    this.educationBookStore.SET_CREATE_VUE(this);
  }
  //#endregion
}
</script>
