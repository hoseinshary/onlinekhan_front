                ...
                <div class="d-flex gap-2">
                  ...
                  <!-- عنوان صفحه -->
                    <div class="container-title-dashboard d-flex align-items-center">
                        ...
                        <h2 class="h3 g-dashboard font-18 mt-3">دروس من</h2>
                    </div>
          ...
          <div class="row">
              ...
              <div class="col-12">
                <div class="bg-gray mt-3 rounded d-flex align-items-center justify-content-between p-3">
                  ...
                  <div>
                    <span class="px-2">دروس خریداری شده من</span>
                  </div>
          ...
          <div  class="row">
            ...
            <div class="container-card shadow position-relative">
              <div class="img-card position-relative">
                <img :src="'http://159.69.82.251:63841/Api/Lesson/GetPictureFile/'+pack.File" class="w-100" alt="">
              </div>
...
export default ({
    ...
    mounted()
    {
     axios.get('/api/Lesson_User/GetAllMyLesson').then((response) => {
